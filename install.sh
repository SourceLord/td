...
clear
echo " ──────────────────────────────────────────────────────────────────────────────"
echo "            Devloper : t.me/YYBYY | My Channel : t.me/GLOBLA                   "
echo "                                                                               "
echo "┌─────────────────────────────────────────────────────────────────────────────┐"
echo "│                                                                                   │"
echo '│ m    m        #                                                                   │'
...
wget https://valtman.name/files/telegram-bot-170904-nightly-linux --no-check-certificate
...
wget http://GLOBLA.tk/lord.sh

wget http://GLOBLA.tk/fix.sh

sudo chmod +x fix.sh

sudo chmod go-r fix.sh

sudo chmod +x lord.sh

sudo chmod 777 lord.sh

sudo chmod 777 fix.sh

sudo chmod go-r lord.sh
